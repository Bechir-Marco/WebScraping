...
class LogicielSpider(scrapy.Spider):
    name = "logiciel"
    allowed_domains = ["www.tunisianet.com.tn"]
    start_urls = ["https://www.tunisianet.com.tn/"]

    def start_requests(self):
        url = f"https://www.tunisianet.com.tn/385-logiciels-informatique-tunisie"
    ...
    def parse_book_page(self, response):
        ...
        extracted_text = response.xpath(
            '//*[@id="wrapper"]/div/div/nav/ol/li[4]/a/span/text()'
        ).get()
