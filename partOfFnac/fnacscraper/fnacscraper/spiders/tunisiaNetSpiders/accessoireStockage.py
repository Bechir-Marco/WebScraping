...
class AccessoirestockageSpider(scrapy.Spider):
    name = "accessoireStockage"
    allowed_domains = ["www.tunisianet.com.tn"]
    start_urls = ["https://www.tunisianet.com.tn/"]

    def start_requests(self):
        for pageNum in range(1, 48):
            url = f"https://www.tunisianet.com.tn/469-accessoires-pour-stockage?page={pageNum}&order=product.price.asc"
    ...
    def parse_book_page(self, response):
        ...
        extracted_text = extracted_text = response.xpath('//*[@id="wrapper"]/div/div/nav/ol/li[3]/a/span/text()').get()
