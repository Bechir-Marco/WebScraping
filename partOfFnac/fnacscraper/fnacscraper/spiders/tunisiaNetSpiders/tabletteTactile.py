...
class TablettetactileSpider(scrapy.Spider):
    name = "tabletteTactile"
    allowed_domains = ["www.tunisianet.com.tn"]
    start_urls = ["https://www.tunisianet.com.tn/"]

    def start_requests(self):
        for pageNum in range(1, 12):
            url = f"https://www.tunisianet.com.tn/396-tablette-tactile-tunisie?page={pageNum}&order=product.price.asc"
