...
class AdhesifAgraphageDecoupeSpider(scrapy.Spider):
    name = "adhesif_Agraphage_Decoupe"
    allowed_domains = ["www.tunisianet.com.tn"]
    start_urls = ["https://www.tunisianet.com.tn"]

    def start_requests(self):
        for pageNum in range(1, 41):
            url = f"https://www.tunisianet.com.tn/481-fournitures-scolaires-en-ligne?page={pageNum}&order=product.price.asc"
