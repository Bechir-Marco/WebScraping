...
class AccessoirebureauSpider(scrapy.Spider):
    name = "accessoireBureau"
    allowed_domains = ["www.tunisianet.com.tn"]
    start_urls = ["https://www.tunisianet.com.tn"]

    def start_requests(self):
        for pageNum in range(1, 41):
            url = f"https://www.tunisianet.com.tn/649-accessoires-de-bureau?page={pageNum}&order=product.price.asc"
