...
class MaterielsecuriteSpider(scrapy.Spider):
    name = "materielSecurite"
    allowed_domains = ["www.tunisianet.com.tn"]
    start_urls = ["https://www.tunisianet.com.tn"]

    def start_requests(self):
        for pageNum in range(1, 41):
            url = f"https://www.tunisianet.com.tn/509-videosurveillance-tunisie?page={pageNum}&order=product.price.asc"
