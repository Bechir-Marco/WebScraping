...
class ClassementarchivageSpider(scrapy.Spider):
    name = "classementArchivage"
    allowed_domains = ["www.tunisianet.com.tn"]
    start_urls = ["https://www.tunisianet.com.tn"]

    def start_requests(self):
        for pageNum in range(1, 41):
            url = f"https://www.tunisianet.com.tn/501-fourniture-classement-archivage-tunisie?page={pageNum}"
