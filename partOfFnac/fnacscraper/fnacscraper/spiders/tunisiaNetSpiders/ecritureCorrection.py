...
class EcriturecorrectionSpider(scrapy.Spider):
    name = "ecritureCorrection"
    allowed_domains = ["www.tunisianet.com.tn"]
    start_urls = ["https://www.tunisianet.com.tn"]

    def start_requests(self):
        for pageNum in range(1, 41):
            url = f"https://www.tunisianet.com.tn/475-fourniture-ecriture-scolaire-tunisie?page={pageNum}&order=product.price.asc"
