...
class MaterielpointventeSpider(scrapy.Spider):
    name = "materielPointVente"
    allowed_domains = ["www.tunisianet.com.tn"]
    start_urls = ["https://www.tunisianet.com.tn"]

    def start_requests(self):
        for pageNum in range(1, 41):
            url = f"https://www.tunisianet.com.tn/490-materiel-point-de-vente?page={pageNum}&order=product.price.asc"
