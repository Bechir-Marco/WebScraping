...
class PeripheriquespiderSpider(scrapy.Spider):
    name = "peripheriquespider"
    allowed_domains = ["www.tunisianet.com.tn"]
    start_urls = ["https://www.tunisianet.com.tn/"]

    def start_requests(self):
        for pageNum in range(1, 33):
            url = f"https://www.tunisianet.com.tn/700-accessoires-et-peripheriques?page={pageNum}&order=product.price.asc"
