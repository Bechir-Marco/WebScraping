...
class CahierblocetfeuilleSpider(scrapy.Spider):
    name = "cahierBlocEtFeuille"
    allowed_domains = ["www.tunisianet.com.tn"]
    start_urls = ["https://www.tunisianet.com.tn"]

    def start_requests(self):
        for pageNum in range(1, 41):
            url = f"https://www.tunisianet.com.tn/589-cahier-bloc-feuille-note?page={pageNum}&order=product.price.asc"
