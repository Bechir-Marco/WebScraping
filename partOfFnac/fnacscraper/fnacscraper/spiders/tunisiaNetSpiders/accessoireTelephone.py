...
class AccessoiretelephoneSpider(scrapy.Spider):
    name = "accessoireTelephone"
    allowed_domains = ["www.tunisianet.com.tn"]
    start_urls = ["https://www.tunisianet.com.tn/"]

    def start_requests(self):
        for pageNum in range(1, 40):
            url = f"https://www.tunisianet.com.tn/378-accessoire-telephonie-mobile-tunisie?page={pageNum}&order=product.price.asc"
