...
class ScienceettechniqueSpider(scrapy.Spider):
    name = "scienceEtTechnique"
    allowed_domains = ["www.alkitab.tn"]
    start_urls = ["https://www.alkitab.tn"]

    def start_requests(self):
        for pageNum in range(1, 3000):
            url = f"https://www.alkitab.tn/listeliv.php?rayon=Sciences+%26+Techniques&select_tri_recherche=pertinence&base=allbooks&codegtl1=10000000&page={pageNum}"
