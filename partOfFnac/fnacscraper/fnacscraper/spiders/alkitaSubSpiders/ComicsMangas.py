...
class ComicsmangasSpider(scrapy.Spider):
    name = "ComicsMangas"
    ...
    def start_requests(self):
        for pageNum in range(1, 3000):
            url = f"https://www.alkitab.tn/listeliv.php?rayon=Bandes+dessin%C3%A9es+%2F+Comics+%2F+Mangas&select_tri_recherche=pertinence&base=allbooks&codegtl1=3000000&page={pageNum}"
