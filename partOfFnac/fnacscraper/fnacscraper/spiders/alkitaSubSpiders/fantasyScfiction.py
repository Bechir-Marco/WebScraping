...
class FantasyscfictionSpider(scrapy.Spider):
    name = "fantasyScfiction"
    allowed_domains = ["www.alkitab.tn"]
    start_urls = ["https://www.alkitab.tn/"]

    def start_requests(self):
        for pageNum in range(1, 3000):
            url = f"https://www.alkitab.tn/listeliv.php?rayon=Fantasy+%26+Science-fiction&select_tri_recherche=pertinence&base=allbooks&codegtl1=91000000&page={pageNum}"
