...
class LoisirSpider(scrapy.Spider):
    name = "loisir"
    ...
    def start_requests(self):
        for pageNum in range(1, 3000):
            url = f"https://www.alkitab.tn/listeliv.php?rayon=Vie+pratique+%26+Loisirs&select_tri_recherche=pertinence&base=allbooks&codegtl1=4000000&page={pageNum}"
