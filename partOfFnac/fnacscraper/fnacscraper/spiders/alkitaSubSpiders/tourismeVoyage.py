...
class TourismevoyageSpider(scrapy.Spider):
    name = "tourismeVoyage"
    ...
    def start_requests(self):
        for pageNum in range(1, 3000):
            url = f"https://www.alkitab.tn/listeliv.php?rayon=Tourisme+%26+Voyages&select_tri_recherche=pertinence&base=allbooks&codegtl1=5000000&page={pageNum}"
