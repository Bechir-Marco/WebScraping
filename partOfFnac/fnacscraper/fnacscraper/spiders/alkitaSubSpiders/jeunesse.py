...
class JeunesseSpider(scrapy.Spider):
    name = "jeunesse"
    ...
    def start_requests(self):
        for pageNum in range(1, 3000):
            url = f"https://www.alkitab.tn/listeliv.php?rayon=Jeunesse&select_tri_recherche=pertinence&base=allbooks&codegtl1=2000000&page={pageNum}"
