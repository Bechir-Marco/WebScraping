...
class ReligionesoterismeSpider(scrapy.Spider):
    name = "religionEsoterisme"
    allowed_domains = ["www.alkitab.tn"]
    start_urls = ["https://www.alkitab.tn/"]

    def start_requests(self):
        for pageNum in range(1, 3000):
            url = f"https://www.alkitab.tn/listeliv.php?rayon=Religion+%26+Esot%C3%A9risme&select_tri_recherche=pertinence&base=allbooks&codegtl1=7000000&page={pageNum}"
