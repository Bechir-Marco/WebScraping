...
class ScolaireSpider(scrapy.Spider):
    name = "scolaire"
    ...
    def start_requests(self):
        for pageNum in range(1, 3000):
            url = f"https://www.alkitab.tn/listeliv.php?rayon=Scolaire&select_tri_recherche=pertinence&base=allbooks&codegtl1=11000000&page={pageNum}"
