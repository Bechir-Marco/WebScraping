...
class ArtspectacleSpider(scrapy.Spider):
    name = "ArtSpectacle"
    ...
    def start_requests(self):
        for pageNum in range(1, 3000):
            url = f"https://www.alkitab.tn/listeliv.php?rayon=Arts+et+spectacles&select_tri_recherche=pertinence&base=allbooks&codegtl1=6000000&page={pageNum}"
