...
class EconomiedroitSpider(scrapy.Spider):
    name = "EconomieDroit"
    ...
    def start_requests(self):
        for pageNum in range(1, 3000):
            url = f"https://www.alkitab.tn/listeliv.php?rayon=Entreprise%2C+%C3%A9conomie+%26+droit&select_tri_recherche=pertinence&base=allbooks&codegtl1=8000000&page={pageNum}"
