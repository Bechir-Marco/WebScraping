...
class SchumaineetsocialeSpider(scrapy.Spider):
    name = "scHumaineEtSociale"
    allowed_domains = ["www.alkitab.tn"]
    start_urls = ["https://www.alkitab.tn"]

    def start_requests(self):
        for pageNum in range(1, 3000):
            url = f"https://www.alkitab.tn/listeliv.php?rayon=Sciences+humaines+%26+sociales&select_tri_recherche=pertinence&base=allbooks&codegtl1=9000000&page={pageNum}"
