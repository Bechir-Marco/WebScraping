...
class ParascolarieSpider(scrapy.Spider):
    name = "parascolarie"
    ...
    def start_requests(self):
        for pageNum in range(1, 3000):
            url = f"https://www.alkitab.tn/listeliv.php?rayon=Parascolaire&select_tri_recherche=pertinence&base=allbooks&codegtl1=12000000&page={pageNum}"
