...
const tunisianet_1 = __importDefault(require("../models/tunisianet"));
router.get(`/`, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const totalItems = yield tunisianet_1.default.countDocuments();
        ...
        const itemsList = yield tunisianet_1.default
            .find(query)
...
router.get(`/item/:id`, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const item = yield tunisianet_1.default.findById(req.params.id);
        console.log(item);
        if (!item) {
