...
const AlkitabProductForListComponent = () => {
   ...
   useEffect(() => {
     ...
     let apiUrl = 'http://127.0.0.1:3200/alkitab/';
         ...
         <Row key={item.idx}>
           ...
           <Col lg={7}>
             <Card.Body>
               ...
               <LinkContainer to={`/alkitab/item/${item._id}`}>
...
export default AlkitabProductForListComponent;
